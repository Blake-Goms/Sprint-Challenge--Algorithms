class SortingRobot:
    ...
    def sort(self):
        ...
        '''
            Idea: Take the value none, and as we move along sorting, 
            we eventually grab the smallest number and on our way back left
            we swap that smallest number with None, move right 1,
            swap None with that value, then continue on again until
            we have None at the end and cannot move right
